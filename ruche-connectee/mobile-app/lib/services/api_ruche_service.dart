...
class ApiRucheService {
  ...
  Future<RucheResponse> ajouterRuche({
    ...
    try {
      LoggerService.info(
          '🐝 Ajout d\'une nouvelle ruche via API: $nom dans le rucher: $idRucher');
      ...
      final rucheResponse =
          RucheResponse.fromJson(response.data as Map<String, dynamic>);

      LoggerService.info(
          '🐝 Ruche créée avec succès via API. ID: ${rucheResponse.id}');
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de l\'ajout de la ruche',
          500);
    }
  }
  ...
  Future<List<RucheResponse>> obtenirRuchesUtilisateur() async {
    try {
      ...
      LoggerService.info(
          '🐝 ${ruches.length} ruche(s) récupérée(s) avec succès (API)');
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de la récupération des ruches',
          500);
    }
  }
  ...
  Future<List<RucheResponse>> obtenirRuchesParRucher(String idRucher) async {
    try {
      LoggerService.info(
          '🐝 Récupération des ruches pour le rucher: $idRucher (API - triées par nom)');
      ...
      LoggerService.info(
          '🐝 ${ruches.length} ruche(s) récupérée(s) avec succès pour le rucher: $idRucher (API - triées par nom)');

      return ruches;
    } catch (e) {
      LoggerService.error(
          'Erreur lors de la récupération des ruches par rucher', e);
  ...
  Future<List<DonneesCapteur>> obtenirMesures7DerniersJours(
      String idRuche) async {
    try {
      LoggerService.info(
          '📊 Récupération des mesures des 7 derniers jours pour la ruche: $idRuche (API)');
      ...
      LoggerService.info(
          '📊 ${mesures.length} mesure(s) récupérée(s) avec succès pour la ruche: $idRuche (7 derniers jours)');

      return mesures;
    } catch (e) {
      LoggerService.error(
          'Erreur lors de la récupération des mesures des 7 derniers jours', e);
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de la récupération des mesures',
          500);
    }
  }
  ...
  Future<DonneesCapteur?> obtenirDerniereMesure(String idRuche) async {
    try {
      LoggerService.info(
          '📊 Récupération de la dernière mesure pour la ruche: $idRuche (API)');
      ...
      if (response.data == null) {
        LoggerService.info(
            '📊 Aucune mesure disponible pour la ruche: $idRuche');
        return null;
      }

      final mesure =
          DonneesCapteur.fromJson(response.data as Map<String, dynamic>);

      LoggerService.info(
          '📊 Dernière mesure récupérée avec succès pour la ruche: $idRuche (${mesure.timestamp})');

      return mesure;
    } catch (e) {
      LoggerService.error(
          'Erreur lors de la récupération de la dernière mesure', e);
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de la récupération de la dernière mesure',
          500);
    }
  }
  ...
  Future<RucheResponse?> obtenirRucheParId(String idRuche) async {
    try {
      ...
      LoggerService.info(
          '🐝 Ruche récupérée avec succès: ${rucheResponse.nom}');

      return rucheResponse;
    } catch (e) {
      LoggerService.error(
          'Erreur lors de la récupération de la ruche par ID', e);
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de la récupération de la ruche',
          500);
    }
  }
  ...
  Future<void> supprimerRuche(String idRuche) async {
    try {
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de la suppression de la ruche',
          500);
    }
  }
  ...
  Future<HealthResponse> verifierSanteAPI() async {
    try {
      ...
      LoggerService.error(
          'Erreur lors de la vérification de la santé de l\'API', e);
      ...
      throw RucheApiException(
          'Une erreur inattendue s\'est produite lors de la vérification de la santé de l\'API',
          500);
    }
  }
}
