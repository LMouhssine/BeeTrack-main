class ApiConfig {
  ...
  static String ruchesByRucherUrl(String rucherId) =>
      '$fullRuchesUrl/rucher/$rucherId';
  static String mesures7JoursUrl(String rucheId) =>
      '$fullRuchesUrl/$rucheId/mesures-7-jours';
  static String derniereMesureUrl(String rucheId) =>
      '$fullRuchesUrl/$rucheId/mesures/last';
