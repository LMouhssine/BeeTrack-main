...
class RucheDetailScreen extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow('Température', '24°C'),
                    const Divider(),
                    _buildInfoRow('Humidité', '65%'),
                    const Divider(),
                    _buildInfoRow('Poids', '25kg'),
                  ],
                ),
              ),
            ),
